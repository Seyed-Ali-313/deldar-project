...
export default function PersianDatePicker({
  ...
  return (
    <div className="pill" style={{ position: "relative" }} ref={wrapperRef}>
      <div
        style={{
          position: "relative",
          width: "100%",
      ...
      {open && (
        ...
        >
          {/* ===== هدر با ماه و سال بزرگ‌تر و بولدتر ===== */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            {view === "years" && (
              ...
              >
                ...
                >
                  {toPersianDigits(baseYear)} – {toPersianDigits(baseYear + 9)}
                </span>
                <button
                  type="button"
                  onClick={() => setYearPage((p) => p + 1)}
              ...
              {MONTH_NAMES.map((name, idx) => (
                <button
                  ...
                  style={{
                    ...
                    color: viewMonth === idx + 1 ? THEME.textDark : THEME.text,
                    transition: "all 0.15s ease",
                    boxShadow:
                      viewMonth === idx + 1
                        ? `0 3px 12px ${THEME.goldGlow}`
              ...
              {yearList.map((y) => (
                <button
                  ...
                  style={{
                    ...
                    transition: "all 0.15s ease",
                    boxShadow:
                      viewYear === y ? `0 3px 12px ${THEME.goldGlow}` : "none",
                    fontFamily: "w_Lotus, sans-serif",
                  }}
                  onMouseEnter={(e) => {
                    if (viewYear !== y) {
